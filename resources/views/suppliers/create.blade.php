                            ...
                            <div class="col-md-6">
                                ...
                                >
                                    @foreach($provinces ?? [] as $province)
                                        <option
                                            value="{{ $province['id'] }}"
                                            {{ old('province_id', $supplier['province_id'] ?? '') == $province['id'] ? 'selected' : '' }}
                                ...
                                >
                                    @foreach($municipalities ?? [] as $municipality)
                                        <option
                                            ...
                                            {{ old('municipality_id', $supplier['municipality_id'] ?? '') == $municipality['id'] ? 'selected' : '' }}
                                ...
                                >
                                    @foreach($neighborhoods ?? [] as $neighborhood)
                                        <option
                                            ...
                                            {{ old('neighborhood_id', $supplier['neighborhood_id'] ?? '') == $neighborhood['id'] ? 'selected' : '' }}
                        ...
                        <div class="row g-3">
                            ...
                            <div class="col-md-6">
                                ...
                                <input
                                    ...
                                    value="{{ old('poc_name', $supplier['poc_name'] ?? '') }}"
                                    autocomplete="off"
                                />
                                @error('poc_name')
                                <div class="invalid-feedback">{{ $message }}</div>
                            ...
                            <div class="col-md-6">
                                ...
                                <input
                                    ...
                                    value="{{ old('poc_email', $supplier['poc_email'] ?? '') }}"
                                    autocomplete="off"
                                />
                                @error('poc_email')
                                <div class="invalid-feedback">{{ $message }}</div>
                            ...
                            <div class="col-md-6">
                                ...
                                <input
                                    ...
                                    placeholder="e.g. +1 234 567 8900"
                                    value="{{ old('poc_phone', $supplier['poc_phone'] ?? '') }}"
                                    autocomplete="off"
                                />
                                @error('poc_phone')
                                <div class="invalid-feedback">{{ $message }}</div>
