                ...
                <div class="dropdown pe-dropdown-mega d-none d-md-block">
                    <button class="header-profile-btn btn gap-1 text-start" type="button" data-bs-toggle="dropdown" aria-expanded="false">
                        ...
                        <div class="d-none d-lg-block pe-2">
                            <span class="d-block mb-0 fs-13 fw-semibold">{{ authUser()->name }}</span>
                            <span class="d-block mb-0 fs-12 text-muted">{{ authUser()->roles[0]->name ?? 'N/A' }}</span>
                        </div>
                    </button>
                        ...
                        <div class="border-bottom pb-2 mb-2 d-flex align-items-center gap-2">
                            ...
                            <div>
                                <a href="javascript:void(0)">
                                    <h6 class="mb-0 lh-base">{{ authUser()->name }}</h6>
                                </a>
                                <p class="mb-0 fs-13 text-muted">{{ authUser()->email}}</p>
                            </div>
                        </div>
