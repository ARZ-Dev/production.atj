                    ...
                    <div class="row g-4">
                        ...
                        <div class="col-lg-4 col-sm-12">
                            ...
                            <select class="selectpicker w-100" name="item_type_id" id="item_type_id"
                                ...
                                <option value="{{ $type['id'] }}" @selected(old('item_type_id', $item['item_type_id']
                                    ?? '' )==$type['id'])>
                                    {{ $type['name'] }}
                                </option>
                                @endforeach
                        ...
                        <div class="col-lg-4 col-sm-12">
                            ...
                            <select class="selectpicker w-100" name="sub_type_id" id="sub_type_id"
                                ...
                                <option value="{{ $subType['id'] }}" @selected(old('sub_type_id', $item['sub_type_id']
                                    ?? '' )==$subType['id'])>
                                    {{ $subType['name'] }}
                                </option>
                                @endforeach
                        ...
                        <div class="col-lg-4 col-sm-12">
                            ...
                            <input type="number" class="form-control" name="weight" placeholder="Weight" step="0.0001"
                                min="0" value="{{ old('weight', $item['weight'] ?? '') }}">
                            @error('weight')
                            <small class="text-danger">{{ $message }}</small>
                            @enderror
                        </div>
                        ...
                        <div class="col-lg-4 col-sm-12">
                            ...
                            <input type="number" class="form-control" name="volume" placeholder="Volume" step="0.0001"
                                min="0" value="{{ old('volume', $item['volume'] ?? '') }}">
                            @error('volume')
                            <small class="text-danger">{{ $message }}</small>
                            @enderror
                        </div>
                        ...
                        <div class="card mt-4">
                            ...
                            <div class="card-body">
                                <x-filepond :images="$image ?? []" wire:model="itemImage"
                                    :file-path="$image ? asset('storage/' . $image) : ''"
                                    is-multiple="false" allow-remove="true" delete-event="deleteImage" />
                            </div>
                        </div>
                        <div class="col-12">
                            <hr>
                        ...
                        <div class="col-lg-4 col-sm-12">
                            <div class="form-check form-switch mt-2">
                                <input class="form-check-input" type="checkbox" name="with_formula" id="with_formula"
