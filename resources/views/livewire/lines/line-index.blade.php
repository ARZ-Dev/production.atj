        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header d-flex justify-content-between align-items-center">
                    ...
                    @hasPermission('production.line-create')
                ...
                <div class="card-body" wire:ignore>
                    <table id="lines-table" class="table table-nowrap table-striped table-bordered w-100">
                        <thead>
                            <tr>
                                <th>#</th>
                                <th>Name</th>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>{{ $line->name }}</td>
                                <td>
                                    @php $dept = collect($departments)->firstWhere('id', $line->department_id); @endphp
                                    {{ $dept['name'] ?? '—' }}
                                </td>
                                <td>
                                ...
                                <td>
                                    @if($line->eventTypes->count())
                                        <div class="d-flex flex-wrap gap-1">
                                            @foreach($line->eventTypes as $et)
                                ...
                                <td>
                                    <a href="{{ route('lines.capacity', $line->id) }}"
                                        class="btn btn-light-success icon-btn-sm"
                                        title="Manage Capacity">
                                        <i class="bi bi-speedometer2"></i>
                                    </a>
                                    @hasPermission('production.line-edit')
                                    <button type="button" wire:click="edit({{ $line->id }})"
                                        class="btn btn-light-primary icon-btn-sm"
                                        data-bs-toggle="tooltip" data-bs-placement="top" data-bs-title="Edit">
                                        <i class="bi bi-pencil-square"></i>
                                    </button>
                                    @endhasPermission
                                    @hasPermission('production.line-delete')
