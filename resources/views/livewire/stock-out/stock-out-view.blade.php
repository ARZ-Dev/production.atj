<div>
    @php
        ...
        [$statusClass, $statusIcon] = $statusMap[$stockOut->status] ?? ['muted', 'bi-circle'];
    @endphp

    {{-- Header --}}
    <div class="pv-header">
        <div>
            <div class="pv-title">Stock Out #{{ $stockOut->id }}</div>
            <div class="pv-chips">
        ...
        <a href="{{ route('item-stock-outs') }}" class="btn btn-light btn-sm flex-shrink-0">
    ...
    <div class="pv-stats">
        ...
        <div class="pv-stat pv-stat--warning">
            ...
            <div class="s-val s-val--sm">{{ ucfirst($stockOut->status) }}</div>
        </div>
    </div>

    {{-- Notes --}}
    @if(!empty($stockOut->notes))
    <div class="sv-notes">
        <div class="sv-notes-label"><i class="bi bi-sticky me-1"></i> Notes</div>
        <div class="sv-notes-body">{{ $stockOut->notes }}</div>
    </div>
    @endif
    ...
    <div class="pv-board">
        <div class="pv-board-head">
            ...
            <div class="pv-board-title">Stock Out Items</div>
        ...
        <div class="pv-empty">
            ...
            <p class="mb-0 text-muted">No items on this stock out.</p>
        </div>
        @endif
    </div>
</div>
