        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header d-flex justify-content-between align-items-center">
                    ...
                    @hasPermission('production.itemStockOut-create')
                    <a href="{{ route('item-stock-outs.create') }}" class="btn btn-primary">
                    ...
                    <table id="buttons-datatables" class="table table-nowrap table-striped table-bordered w-100">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                @endif
                                <td>
                                    @hasPermission('production.itemStockOut-view')
                                    <a href="{{ route('item-stock-outs.view', [$stockOut->id, 1]) }}"
                                    ...
                                    @endhasPermission
                                    @if ($stockOut->status === 'pending')
                                        @hasPermission('production.itemStockOut-approve')
                                        ...
                                        @endhasPermission
                                        @hasPermission('production.itemStockOut-edit')
                                        <a href="{{ route('item-stock-outs.edit', $stockOut->id) }}"
