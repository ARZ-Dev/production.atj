        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header d-flex justify-content-between align-items-center">
                    ...
                    @hasPermission('production.stockOut-create')
                    ...
                    <table id="buttons-datatables" class="table table-nowrap table-striped table-bordered w-100">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    @if ($stockOut->status === 'pending')
                                    @hasPermission('production.stockOut-approve')
                                    ...
                                    @endhasPermission
                                    @hasPermission('production.stockOut-edit')
                                    ...
                                    @hasPermission('production.stockOut-delete')
