            ...
            <div class="col-xl">
                ...
                <div class="card mb-4">
                    <div class="card-header d-flex justify-content-between align-items-center">
                        ...
                        <a href="{{ route('raw-material-stock-ins') }}" class="btn btn-light-light text-muted">
                    ...
                    <div class="card-body">
                        <div class="row g-3">
                            ...
                            <div class="col-12">
                                ...
                                <textarea cols="15" rows="5" class="form-control" id="notes" wire:model="notes"
                                    placeholder="StockIn Notes"></textarea>
                                @error('notes')
                                <div class="text-danger small mt-1">{{ $message }}</div>
                                @enderror
                            </div>
                                        ...
                                        <div class="col-12 col-md-4">
                                            ...
                                            <div wire:ignore>
                                                <select wire:model="rawMaterials.{{ $index }}.raw_material_id"
                                                    ...
                                                    <option value="{{ $rm->id }}" @selected($rm->id ==
                                        ...
                                        <div class="col-12 col-md-4">
                                            ...
                                            <div wire:ignore>
                                                <select wire:model="rawMaterials.{{ $index }}.unit_id"
                                                    ...
                                                    <option value="{{ $unit['id'] }}" @selected(($item['unit_id'] ?? ''
                                                        )==$unit['id'])>
                                                        {{ $unit['name'] }}
                                                    </option>
                                                    @endforeach
