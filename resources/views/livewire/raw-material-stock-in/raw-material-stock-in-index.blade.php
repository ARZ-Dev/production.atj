            ...
            <div class="card">
                <div class="card-header d-flex justify-content-between align-items-center">
                    <h5 class="card-title mb-0">StockIn List</h5>
                     @hasPermission('production.rawMaterialStockIn-create')
                    <a href="{{ route('raw-material-stock-ins.create') }}" class="btn btn-primary">
                    ...
                    <table id="buttons-datatables" class="table table-nowrap table-striped table-bordered w-100">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                @endif
                                <td>
                                    {{--  @hasPermission('production.rawMaterialStockIn-view')
                                    <a href="{{ route('raw-material-stock-ins.view',[ $stockIn->id , $viewStatus = 1]) }}"
                                    ...
                                    @endhasPermission --}}
                                    @if ($stockIn->status === 'pending')
                                     @hasPermission('production.rawMaterialStockIn-approve')
                                    ...
                                    @endhasPermission
                                     @hasPermission('production.rawMaterialStockIn-edit')
                                    <a href="{{ route('raw-material-stock-ins.edit', $stockIn->id) }}"
                                    ...
                                    @endif
                                     ...
                                     @hasPermission('production.rawMaterialStockIn-delete')
