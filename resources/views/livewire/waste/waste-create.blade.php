                ...
                <div class="card mb-4">
                    <div class="card-header d-flex justify-content-between align-items-center">
                        ...
                        <button type="button" class="btn btn-success btn-sm" wire:click="addRow">
                            <i class="ti ti-plus me-1"></i> Add Waste Item
                        </button>
                    </div>
                    <div class="card-body">
                        @if(count($wasteItems) > 0)
                            <div class="row g-3">
                                @foreach($wasteItems as $index => $row)
                        ...
                        @else
                            <div class="text-center py-4">
                                <p class="text-muted mb-0">No items added yet. Click "Add Waste Item" to start.</p>
                            </div>
                        @endif
                    </div>
                </div>
