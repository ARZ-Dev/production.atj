        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header d-flex justify-content-between align-items-center">
                    ...
                    @hasPermission('production.itemWaste-create')
                    <a href="{{ route('item-wastes.create') }}" class="btn btn-primary">
                            ...
                            <tr>
                                ...
                                <td>
                                    @if ($waste->status === 'pending')
                                        ...
                                        @endhasPermission
                                        @hasPermission('production.itemWaste-edit')
                                        <a href="{{ route('item-wastes.edit', $waste->id) }}"
