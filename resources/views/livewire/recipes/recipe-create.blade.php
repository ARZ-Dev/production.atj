                        ...
                        <div class="row g-3">
                            ...
                            @if($recipe_type_id)
                                ...
                                <div class="col-12 col-md-4">
                                    ...
                                    <div wire:ignore>
                                        <select id="output_item_type"
                                                wire:model="output_item_type_id"
                                                class="selectpicker w-100"
                                            ...
                                            @foreach($itemTypes as $type)
                                                <option value="{{ $type['id'] }}"
                                                    @selected($output_item_type_id == $type['id'])>
                                                    {{ $type['name'] }}
                                                </option>
                                            @endforeach
                                        </select>
                                                    ...
                                                    <div class="col-12 col-md-4">
                                                        ...
                                                        <div wire:ignore>
                                                            <select id="section_item_{{ $sectionIndex }}_{{ $rowIndex }}"
                                                                    class="selectpicker w-100 section-item-select"
                                                                    title="Select Item"
                                                                    data-style="btn-default"
                                                                    data-live-search="true"
                                                                    data-icon-base="ti"
