        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header d-flex justify-content-between align-items-center">
                    ...
                    @hasPermission('production.rawMaterialTransfer-create')
                    <a href="{{ route('raw-material-transfers.create') }}" class="btn btn-primary">
                    ...
                    <table id="buttons-datatables" class="table table-nowrap table-striped table-bordered w-100">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    @if ($transfer->status === 'pending')
                                        @hasPermission('production.rawMaterialTransfer-approve')
                                        <a href="{{ route('raw-material-transfers.approve-load', $transfer->id) }}"
                                        ...
                                        @hasPermission('production.rawMaterialTransfer-edit')
                                        <a href="{{ route('raw-material-transfers.edit', $transfer->id) }}"
                                        ...
                                        @hasPermission('production.rawMaterialTransfer-delete')
                                    ...
                                    @elseif ($transfer->status === 'loaded')
                                        @hasPermission('production.rawMaterialTransfer-approve')
                                        <a href="{{ route('raw-material-transfers.approve-receive', $transfer->id) }}"
                                            class="btn btn-light-success icon-btn-sm" data-bs-toggle="tooltip"
                                            data-bs-custom-class="tooltip-white" data-bs-placement="top"
