        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header d-flex justify-content-between align-items-center">
                    ...
                    @hasPermission('production.rawMaterialWaste-create')
                    <a href="{{ route('raw-material-wastes.create') }}" class="btn btn-primary">
                    ...
                    <table id="buttons-datatables" class="table table-nowrap table-striped table-bordered w-100">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    @if ($waste->status === 'pending')
                                    @hasPermission('production.rawMaterialWaste-approve')
                                    ...
                                    @endhasPermission
                                    @hasPermission('production.rawMaterialWaste-edit')
                                    <a href="{{ route('raw-material-wastes.edit', $waste->id) }}"
                                    ...
                                    @hasPermission('production.rawMaterialWaste-delete')
