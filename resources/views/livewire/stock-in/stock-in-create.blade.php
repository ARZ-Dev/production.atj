            ...
            <div class="col-xl">
                ...
                <div class="card mb-4">
                    <div class="card-header d-flex justify-content-between align-items-center">
                        <h5 class="mb-0">{{ $editing ? 'Edit' : 'Add' }} Stock In</h5>
                        <a href="{{ route('item-stock-ins') }}" class="btn btn-light-light text-muted">
                        ...
                        <div class="row g-3">
                            ...
                            <div class="col-12">
                                ...
                                <textarea class="form-control"
                                          ...
                                          wire:model="notes"
                                          rows="3"
                                          placeholder="Stock In Notes"></textarea>
                                @error('notes')
                                    <div class="text-danger small mt-1">{{ $message }}</div>
                                @enderror
                            </div>
                ...
                <div class="card mb-4">
                    <div class="card-header d-flex justify-content-between align-items-center">
                        <div class="d-flex align-items-center gap-2">
                            ...
                            <span class="ir-count">{{ count($stockInItems) }}</span>
                        </div>
                    </div>
                    <div class="card-body">
                        <div class="ir-editor">
                            ...
                            @forelse($stockInItems as $index => $row)
                                <div class="ir-row ir-cols-basic" wire:key="stock-in-row-{{ $index }}">
                            ...
                            <button type="button" class="ir-add" wire:click="addRow">
                                <i class="bi bi-plus-lg"></i> Add Stock In Item
                            </button>
                        </div>
                    </div>
                </div>
