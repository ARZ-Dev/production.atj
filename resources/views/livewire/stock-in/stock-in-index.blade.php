        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header d-flex justify-content-between align-items-center">
                    ...
                    @hasPermission('production.stockIn-create')
                    ...
                    <table id="buttons-datatables" class="table table-nowrap table-striped table-bordered w-100">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                @endif
                                <td>
                                    {{-- @hasPermission('production.stockIn-view')
                                    <a href="{{ route('stock-ins.view',[ $stockIn->id , $viewStatus = 1]) }}"
                                    ...
                                    @endhasPermission --}}
                                    @if ($stockIn->status === 'pending')
                                    @hasPermission('production.stockIn-approve')
                                    ...
                                    @endhasPermission
                                    @hasPermission('production.stockIn-edit')
                                    <a href="{{ route('stock-ins.edit', $stockIn->id) }}"
                                    ...
                                    @hasPermission('production.stockIn-delete')
