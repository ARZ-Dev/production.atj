            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header d-flex justify-content-between align-items-center">
                        <h5 class="card-title mb-0">{{ $editing ? 'Edit Shift' : 'Create Shift' }}</h5>
                        <a href="{{ route('shifts') }}" class="btn btn-light-secondary">
                    ...
                    <div class="card-body">
                        <div class="row g-4">
                            ...
                            <div class="col-12 col-md-6">
                                ...
                                <input type="time" class="form-control" id="to_time" name="to_time" wire:model="to_time">
