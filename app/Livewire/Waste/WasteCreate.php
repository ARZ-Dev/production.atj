...
class WasteCreate extends Component
{
    ...
    {
        authorizeRequest('production.waste-create');
        ...
        if ($id) {
            ...
            $this->waste = Waste::with('reportRawMaterials')->findOrFail($id);
            $this->warehouses = $api->get('/v1/warehouses', ['module' => 'production'])['data'] ?? [];
    ...
    public function submit()
    {
        ...
        try {
            ...
            DB::commit();
            return to_route('wastes')->with('success', $this->editing ? 'Waste updated successfully!' : 'Waste created successfully!');
