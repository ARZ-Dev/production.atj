...
class StockOutCreate extends Component
{
    ...
    public function mount(ApiService $api, $id = null, $viewStatus = null)
    {
        ...
        if ($id) {
            ...
            $this->stockOut = StockOut::with('reportRawMaterials')->findOrFail($id);
            $this->warehouses = $api->get('/v1/warehouses', ['module' => 'production'])['data'] ?? [];
    ...
    public function submit()
    {
        ...
        try {
            ...
            DB::commit();
            return to_route('stock-outs')->with('success', $this->editing ? 'Stock Out updated successfully!' : 'Stock Out created successfully!');
