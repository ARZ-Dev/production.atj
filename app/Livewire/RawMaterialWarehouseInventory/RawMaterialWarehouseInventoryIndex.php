...
namespace App\Livewire\RawMaterialWarehouseInventory;
...
class RawMaterialWarehouseInventoryIndex extends Component
{
    ...
    {
        return RawMaterialWarehouseInventory::where('warehouse_id', $warehouseId)
    ...
    {
        return view('livewire.raw-material-warehouse-inventory.raw-material-warehouse-inventory-index');
    }
}